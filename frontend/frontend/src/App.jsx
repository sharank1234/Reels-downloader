    ...
    <div style={{ minHeight: '100vh', background: 'radial-gradient(circle at 10% 20%, rgba(131,58,180,0.35) 0%, rgba(253,29,29,0.2) 50%, rgba(252,176,69,0.15) 100%), #090d16', color: '#fff', display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '24px 16px 40px', fontFamily: 'system-ui, sans-serif', boxSizing: 'border-box' }}>
      <div style={{ width: '100%', maxWidth: '480px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '20px' }}>
          <h1 style={{ fontSize: '28px', fontWeight: 900, color: activeTab === 'instagram' ? '#ff3b81' : '#f87171', margin: '0 0 6px 0' }}>
        ...
        {loading && (
          <div style={{ marginTop: '20px', width: '100%', background: 'rgba(30, 41, 59, 0.5)', border: '1px solid rgba(255, 255, 255, 0.1)', borderRadius: '20px', padding: '30px 20px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '12px', textAlign: 'center', boxSizing: 'border-box' }}>
            ...
            <span style={{ fontSize: '14px', color: '#cbd5e1', fontWeight: 600 }}>Fetching media...</span>
          </div>
        )}
        ...
        {activeTab === 'youtube' && !result && !loading && (
          <div style={{ marginTop: '22px', width: '100%', background: 'linear-gradient(145deg, rgba(30, 41, 59, 0.85) 0%, rgba(20, 10, 20, 0.85) 100%)', border: '1px solid rgba(239, 68, 68, 0.35)', borderRadius: '24px', padding: '24px 20px', boxSizing: 'border-box', textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '12px' }}>
            <div style={{ width: '48px', height: '48px', borderRadius: '50%', background: 'rgba(239, 68, 68, 0.15)', border: '1px solid rgba(239, 68, 68, 0.3)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '22px' }}>🚀</div>
            <h3 style={{ margin: 0, fontSize: '17px', fontWeight: 800, color: '#fca5a5' }}>YouTube Engine In The Lab 🧪</h3>
            <p style={{ margin: 0, fontSize: '13px', lineHeight: '1.6', color: '#cbd5e1' }}>We are currently building high-speed cloud streaming pipelines for YouTube video support. ⚡</p>
          ...
          <div style={{ marginTop: '28px', width: '100%', display: 'flex', flexDirection: 'column', gap: '18px' }}>
            ...
            <div style={{ background: 'rgba(30, 41, 59, 0.65)', border: '1px solid rgba(255, 255, 255, 0.1)', borderRadius: '18px', padding: '18px' }}>
              ...
              <p style={{ fontSize: '13px', lineHeight: '1.6', color: '#cbd5e1', margin: '0 0 8px 0' }}>
                A free and fast tool for Instagram reels video download in HD. With this downloader, save high quality MP4 videos to your phone gallery without login details. Free service for everyone with unlimited downloads.
              </p>
              <p style={{ fontSize: '13px', lineHeight: '1.6', color: '#94a3b8', margin: 0 }}>
                We do not use Instagram API or require account credentials. Download anonymously without signup.
              </p>
            </div>
            ...
            <div style={{ background: 'rgba(30, 41, 59, 0.65)', border: '1px solid rgba(255, 255, 255, 0.1)', borderRadius: '18px', padding: '18px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                {[
                  ...
                  <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '6px 8px', background: 'rgba(15, 23, 42, 0.6)', borderRadius: '8px' }}>
                    <span style={{ color: '#ec4899', fontSize: '13px' }}>✓</span>
        ...
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.8)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '16px', zIndex: 999 }}>
          <div style={{ background: '#1e293b', border: '1px solid rgba(255,255,255,0.15)', borderRadius: '18px', width: '100%', maxWidth: '400px', padding: '20px', boxSizing: 'border-box' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '14px' }}>
              <h3 style={{ margin: 0, fontSize: '17px', fontWeight: 700 }}>{activeModal === 'guide' ? '📖 Guide' : activeModal === 'faq' ? '❓ FAQ' : '💬 Support'}</h3>
            ...
            {activeModal === 'guide' && <div style={{ fontSize: '13px', color: '#cbd5e1', lineHeight: '1.6' }}>1. Paste any public Instagram link.<br/>2. Tap Fetch Media.<br/>3. Preview and download in 1 tap.</div>}
            {activeModal === 'faq' && <div style={{ fontSize: '13px', color: '#cbd5e1', lineHeight: '1.6' }}>• Supports Instagram Reels, Video posts, and Photo posts.<br/>• 100% free and unlimited.</div>}
            {activeModal === 'contact' && (
              <div style={{ fontSize: '13px', color: '#cbd5e1' }}>
                <p style={{ margin: '0 0 8px 0' }}>Need help or encountered an issue?</p>
